function [Fi,Ai] = gaussian_kernel_grad_2(params,i)
...
Fi = [];
if i == 1
    Fi = rskelf(@Afun_grad1,x,occ,rskelf_tol,@pxyfun_grad1,opts);
elseif i == 2
    Fi = rskelf(@Afun_grad2,x,occ,rskelf_tol,@pxyfun_grad2,opts);
end
